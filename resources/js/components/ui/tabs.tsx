...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            'inline-flex h-10 items-center justify-center rounded-xl bg-[var(--bg-tertiary)] p-1 text-[var(--text-muted)]',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            'dark:data-[state=active]:bg-blue-600/20 dark:data-[state=active]:text-blue-400',
            className
        )}
        {...props}
    />
